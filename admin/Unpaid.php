...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-9">
                <h1><i class="fa fa-user"></i> Unpaid Users<hr>
                </h1>
                <ol class="breadcrumb">
                    <li>
                        <a href="index.html" class="active"> <i class="fa fa-tachometer"></i> Dashboard</a>
                    </li>
                    <li class="active"> <i class="fa fa-users"></i>Unpaid Users</li>
                </ol>
                ...
                <div class="row">
                 ...
                 <a href="add_user.php" class="btn btn-warning">Add New</a>
                    ...
                    <table class="table table-hower table-border table-stripped">
                        ...
                        <tbody>
                     <?php
          $query='SELECT * FROM users  WHERE fees="Unpaid"';
                 ...
                 <?php
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td><a href="Unpaid.php?del=<?php echo $id;?>"><i class="fa fa-times"></i></a></td>
                            </tr>
                      <?php 
                    }
                            ?>
